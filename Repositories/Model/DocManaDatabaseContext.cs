...
public partial class DocManaDatabaseContext : DbContext
{
    public DocManaDatabaseContext()
    {
    }

    public DocManaDatabaseContext(DbContextOptions<DocManaDatabaseContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=.\\SQLEXPRESS;Database=DocManaDatabase;Trusted_Connection=True;TrustServerCertificate=True;");
